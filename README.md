...
- 🧩 **Organized Codebase**
  - Clean script structure using **state machine** logic
  - Easy-to-understand node organization for reuse in other projects
...
- 🏹 **Optimized Animations**
  - Animation packs split for better modularity  
  - Bow & arrow animations included  
  - You’re free to use bow/arrow models and animations in your own projects  
